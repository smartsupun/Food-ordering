...
>>>>>>> 87ea621d35a24aaf092bd31379e48f5ae20c7e74
<!DOCTYPE html>
<html lang="en">
...
<<<<<<< HEAD
                    alt="" style="width: 70%;" srcset=""></div>
            <div  class="col-lg-7 col-sm-12 wow zoomIn signin-form-div">
                <form  class="signin-form jumbotron" id="signin-form">
=======
...
<<<<<<< HEAD
                        <input type="text" class="form-control" placeholder="Name" id="signin-input" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Address" id="signin-input" required>
=======
...
<<<<<<< HEAD
                    ...
                    <div class="signin-btns">
                        <button type="submit" id="signin-submit" class="btn btn-primary">Log In</button>
                        
                        <a href="signin.php" name="signin" id="signin-signin" class="btn btn-primary">Sign In</a>
=======
